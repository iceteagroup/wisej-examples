namespace TourPanelSample
{
	partial class TourPanel1
	{
		...
		{
            Wisej.Web.Ext.TourPanel.TourStep tourStep1 = new Wisej.Web.Ext.TourPanel.TourStep();
            Wisej.Web.Ext.TourPanel.TourStep tourStep2 = new Wisej.Web.Ext.TourPanel.TourStep();
            Wisej.Web.Ext.TourPanel.TourStep tourStep3 = new Wisej.Web.Ext.TourPanel.TourStep();
            Wisej.Web.Ext.TourPanel.TourStep tourStep4 = new Wisej.Web.Ext.TourPanel.TourStep();
            Wisej.Web.Ext.TourPanel.TourStep tourStep5 = new Wisej.Web.Ext.TourPanel.TourStep();
            Wisej.Web.Ext.TourPanel.TourStep tourStep6 = new Wisej.Web.Ext.TourPanel.TourStep();
            Wisej.Web.Ext.TourPanel.TourStep tourStep7 = new Wisej.Web.Ext.TourPanel.TourStep();
            Wisej.Web.Ext.TourPanel.TourStep tourStep8 = new Wisej.Web.Ext.TourPanel.TourStep();
            Wisej.Web.Ext.TourPanel.TourStep tourStep9 = new Wisej.Web.Ext.TourPanel.TourStep();
            Wisej.Web.Ext.TourPanel.TourStep tourStep10 = new Wisej.Web.Ext.TourPanel.TourStep();
            Wisej.Web.Ext.TourPanel.TourStep tourStep11 = new Wisej.Web.Ext.TourPanel.TourStep();
            Wisej.Web.Ext.TourPanel.TourStep tourStep12 = new Wisej.Web.Ext.TourPanel.TourStep();
            Wisej.Web.Ext.TourPanel.TourStep tourStep13 = new Wisej.Web.Ext.TourPanel.TourStep();
            Wisej.Web.Ext.TourPanel.TourStep tourStep14 = new Wisej.Web.Ext.TourPanel.TourStep();
            Wisej.Web.Ext.TourPanel.TourStep tourStep15 = new Wisej.Web.Ext.TourPanel.TourStep();
            Wisej.Web.Ext.TourPanel.TourStep tourStep16 = new Wisej.Web.Ext.TourPanel.TourStep();
            Wisej.Web.Ext.TourPanel.TourStep tourStep17 = new Wisej.Web.Ext.TourPanel.TourStep();
            ...
            // BackButton
            // 
            this.BackButton.Location = new System.Drawing.Point(491, 3);
            // 
            // ExitButton
            // 
            this.ExitButton.Location = new System.Drawing.Point(395, 3);
            // 
            // TourPanel1
            // 
    ...
    "h AutoPlay on using the 2nd button.";
            ...
            tourStep2.Text = "This is the first form.\r\nIt includes some menus.";
            ...
            tourStep9.Text = "Activates Window2<br/>\r\nActivates tabPage4 of tabControl1<br/>\r\nExpands groupBox1" +
    "<br/>\r\nPoints to textBox1<br/>\r\n";
            ...
            tourStep13.Text = "This is the name<br/>\r\nThe dgv contents are sorted by clicking on the col header " +
    "\r\nif you set the correct SortMode.";
            ...
            tourStep18.Text = "This is an instance of the CKEditor</br>\r\nPlease note the text in <h3 style=\"colo" +
    "r:blue\">blue</h3>";
